...
a("h1.post-title").html():"&nbsp;";a(".main-nav").append('<a id="responsive_menu_button"></a>');
d = 'Меню';
a(".main-nav").prepend('<div id="responsive_current_menu_item">'+d+"</div>");a("a#responsive_menu_button, #responsive_current_menu_item").click(function(){a(".js .main-nav .menu").slideToggle(function(){a(this).is(":visible")?a("a#responsive_menu_button").addClass("responsive-toggle-open"):(a("a#responsive_menu_button").removeClass("responsive-toggle-open"),a(".js .main-nav .menu").removeAttr("style"))})})})(jQuery);

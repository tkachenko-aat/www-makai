...
wp_enqueue_script( 'multi-thumbnails', get_template_directory_uri().'/scripts/multi-thumbnails/multi-post-thumbnails-admin.js', array( 'jquery', 'set-post-thumbnail' ), '9.0', false );
wp_enqueue_script( 'media-modal', get_template_directory_uri().'/scripts/multi-thumbnails/media-modal.js', array( 'jquery', 'media-models' ), '9.0', false );	

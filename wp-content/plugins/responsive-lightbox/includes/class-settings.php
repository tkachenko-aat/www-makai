...
class Responsive_Lightbox_Settings {
	...
	public function load_defaults() {
		...
		/* !!!! */ Responsive_Lightbox()->options['settings']['script'] = 'tosrus'; /////// ////
	...
	public function admin_menu_options() {
		 ...
		 */
		add_submenu_page('themes.php', __('Responsive Lightbox'), __('Responsive Lightbox'), 'manage_options', 'responsive-lightbox', array( $this, 'options_page' ));
	}
	...
	public function options_page() {
		...
		foreach ( $this->tabs as $key => $name ) {
			echo '
			<a class="nav-tab ' . ($tab_key == $key ? 'nav-tab-active' : '') . '" href="' . esc_url( admin_url( 'themes.php?page=responsive-lightbox&tab=' . $key ) ) . '">' . $name['name'] . '</a>';
		}
